...
/*
 * GD32F407 适配说明：
 * - 舵机改用 USART5：PC6(TX) / PC7(RX)
 * - GPIO 复用 AF7
 */
#define BSP_SERVO_UARTx          USART5
#define BSP_SERVO_UART_IRQn      USART5_IRQn

#define BSP_SERVO_TX_PORT        GPIOC
#define BSP_SERVO_TX_CLK         RCU_GPIOC
#define BSP_SERVO_TX_PIN         GPIO_PIN_6

#define BSP_SERVO_RX_PORT        GPIOC
#define BSP_SERVO_RX_CLK         RCU_GPIOC
#define BSP_SERVO_RX_PIN         GPIO_PIN_7

#define BSP_SERVO_UART_CLK       RCU_USART5
