 ...
 * - GPIO 复用 AF7
 */
#define BSP_SERVO_UARTx          USART1
#define BSP_SERVO_UART_IRQn      USART1_IRQn

#define BSP_SERVO_TX_PORT        GPIOD
#define BSP_SERVO_TX_CLK         RCU_GPIOD
#define BSP_SERVO_TX_PIN         GPIO_PIN_5

#define BSP_SERVO_RX_PORT        GPIOD
#define BSP_SERVO_RX_CLK         RCU_GPIOD
#define BSP_SERVO_RX_PIN         GPIO_PIN_6

#define BSP_SERVO_UART_CLK       RCU_USART1
