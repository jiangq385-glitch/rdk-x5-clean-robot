...
/////////////////////////////////////用户配置�?//////////////////////////////////	 
#define USE_HORIZONTAL  	 0//定义液晶屏顺时针旋转方向 	0-0度旋转，1-90度旋转，2-180度旋转，3-270度旋�?
...
extern u16  BACK_COLOR; //背景颜色.默认为白�?
...
#define LCD_RS_SET    gpio_bit_set(LCD_RS_PORT, LCD_RS_PIN)
...
//注意要去掉lcd.c中void LCD_WR_DATA(u16 data)函数定义�?
/*
