...
extern volatile bool isUartRxCompleted;
...
void moveServosByArray(LobotServo servos[], uint8_t Num, uint16_t Time)
{
	...
	uart1WriteBuf(LobotTxBuf, LobotTxBuf[2] + 2);             //发送
}
